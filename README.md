...
## :pager: Tela principal da Site Jungle Adventure

 <img src="https://github.com/cleuber-andrade/landpage_jungle/blob/main/assets/img/jungle.jpg" alt="Tela Principal">

## :globe_with_meridians: Link para acessar site no GitHubPages

Para visualizar o site no GitHubPages <a href="https://cleuber-andrade.github.io/landpage_jungle/" target="_blank">Clique aqui</a>

## 👷 Como rodar

```bash
# Clonar o repositório
git clone https://github.com/cleuber-andrade/landpage_jungle.git
